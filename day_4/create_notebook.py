#!/usr/bin/env python3
"""
Script to create the RAG Parameter Impact Analysis notebook
"""
...
with open('rag_parameter_impact_analysis.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1, ensure_ascii=False)

print("✅ Notebook created successfully: rag_parameter_impact_analysis.ipynb")
